...
class TestSlackNotifier:
    ...
    def test_should_send_notification(self, mocker):
        ...
        mocker.patch("xnetvn_monitord.notifiers.slack_notifier.open_url", return_value=DummyResponse())
    ...
    def test_should_log_sanitized_target_on_url_error(self, mocker, caplog):
        """Test Slack errors log redacted endpoint context."""
    ...
    def test_should_validate_connection_without_sending_startup_test_message(self, mocker):
        """Test startup validation skips the user-facing Slack test message."""
        open_url_mock = mocker.patch("xnetvn_monitord.notifiers.slack_notifier.open_url")
